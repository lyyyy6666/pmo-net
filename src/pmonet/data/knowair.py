...
OFFICIAL_SPLITS: dict[int, dict[str, SplitDateRange]] = {
    1: {
        "train": SplitDateRange("2015-01-01", "2016-12-31"),
        "val": SplitDateRange("2017-01-01", "2017-12-31"),
        "test": SplitDateRange("2018-01-01", "2018-12-31"),
    },
    2: {
        "train": SplitDateRange("2015-11-01", "2016-02-28"),
        "val": SplitDateRange("2016-11-01", "2017-02-28"),
        "test": SplitDateRange("2017-11-01", "2018-02-28"),
    },
    3: {
        "train": SplitDateRange("2016-09-01", "2016-11-30"),
        "val": SplitDateRange("2016-12-01", "2016-12-31"),
        "test": SplitDateRange("2017-01-01", "2017-01-31"),
    },
}
